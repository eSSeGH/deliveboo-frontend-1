    ...
    <header class="header-home">
        <div class="container-sm">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-auto logo d-none d-md-block">
                    <img src="/imgs/logo/logo3.png" alt="">
                </div>
                <div class="col-auto logo-sm d-md-none">
                    <img src="/imgs/logo/logo-sm.png" alt="">
                </div>

                <div class="col-auto searchbar-box">
                    <input type="text" name="search" class="searchbar" placeholder="Cerca ristorante...">
                </div>

                <div class="header-buttons col-auto d-flex gap-4">
